...
[2025년 매일 전자정부 표준프레임워크 4.3.0 공통컴포넌트 PMD 진단 제거](2025년%20매일%20전자정부%20표준프레임워크%204.3.0%20공통컴포넌트%20PMD%20진단%20제거/pmd-report.txt.md)
...
https://github.com/eGovFramework/egovframe-common-components/pull/739
...
### 2025-09-10 수 PMD로 소프트웨어 보안약점 진단하고 제거하기-EgovMenuGov

`FileName` 을 제거하고 `parFile.replace('\\', FILE_SEPARATOR).replace('/', FILE_SEPARATOR)` 으로 수정
...
### 2025-09-11 목 PMD로 소프트웨어 보안약점 진단하고 제거하기-EgovXMLDoc

부적절한 자원 해제를 제거
- 사용되지 않는 `FileInputStream fis = null;` 제거
- `throws Exception` 제거하고 `throw new BaseRuntimeException(e);` 추가

부적절한 자원 해제를 `try-with-resources` 로 수정
- `throws Exception` 제거하고 `throw new UncheckedIOException(e);` 추가
...
https://github.com/eGovFramework/egovframe-common-components/pull/756
...
### 2025-09-13 토 PMD로 소프트웨어 보안약점 진단하고 제거하기-EgovHttpMonServiceImpl

FieldNamingConventions(변수명에 밑줄 사용)
- `HttpMonDAO` 를 `httpMonDAO` 로 이름 바꾸기
...
```
feature/pmd/EgovHttpMonServiceImpl
```
...
https://github.com/eGovFramework/egovframe-common-components/pull/762
